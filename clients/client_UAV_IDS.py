...
from preprocessing.preprocess_UAV_IDS import get_UAV_IDS_dataloaders
...
class UAVIDSClient(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        print(f"UAV Round {self.current_round}")
    ...
    def save_results(self, y_true, y_pred, accuracy, precision, recall, f1):
        ...
        result_dir = f"result/client_UAV_IDS/round_{self.current_round}"
...
if __name__ == "__main__":
    # Prepare data paths
    train_file = "data/uav_ids/train.csv"
    test_file = "data/uav_ids/test.csv"
    ...
    # Load data
    train_loader, test_loader, input_dim, num_classes, label_encoder = get_UAV_IDS_dataloaders(
    ...
    client = UAVIDSClient(model, train_loader, test_loader, label_encoder)
