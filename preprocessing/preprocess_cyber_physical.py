# preprocessing/preprocess_cyber_physical.py
...
class CyberPhysicalDataset(Dataset):
    def __init__(self, data_path):
        """
        Initializes the CyberPhysicalDataset.
        ...
        if non_numeric_cols:
            print(f"Non-numeric columns in Cyber Physical features: {non_numeric_cols}")
...
def get_cyber_physical_dataloaders(train_file, test_file, batch_size=32):
    """
    Creates DataLoaders for training and testing Cyber Physical dataset.
    ...
    """
    # Create datasets
    train_dataset = CyberPhysicalDataset(train_file)
    test_dataset = CyberPhysicalDataset(test_file)
